...
import { computePBs, computeStreaks, fmtK, weekKey, exVolume, est1rm } from '../lib/workoutStats'
...
import type { WorkoutSession, SchedExercise } from '../types'
...
export function Workout() {
  ...
  return (
    <div style={{ maxWidth: 1200, margin: '0 auto', padding: '28px 24px', display: 'flex', flexDirection: 'column', gap: 20 }}>
      ...
      {/* Exercise detail + PR board side by side */}
      ...
      <div style={card}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 6, marginTop: 8 }}>
          {[...sessions].sort((a, b) => b.ts - a.ts).slice(0, 40).map(s => {
            ...
            return (
              <div key={s.id} style={{ borderRadius: 8, overflow: 'hidden', background: 'var(--cardHi)' }}>
                ...
                {open && (
                  <div style={{ padding: '0 14px 12px', display: 'flex', flexDirection: 'column', gap: 5 }}>
                      ...
                      return (
                        <div key={i} style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
                          ...
                          <span style={{ font: "400 9px 'Roboto Mono'", color: 'var(--mut)' }}>
                            {e.sets}×{e.reps} @ {e.weight}{e.mode === 'bodyweight' ? 'bw' : e.mode === 'cardio' ? '' : ' ' + e.mode}
                          </span>
                    ...
                    <div style={{ marginTop: 4, font: "400 9px 'Roboto Mono'", color: 'var(--mut)', borderTop: '1px solid rgba(255,255,255,.07)', paddingTop: 6 }}>
